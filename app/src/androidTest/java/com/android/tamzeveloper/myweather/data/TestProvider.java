...
import com.android.tamzeveloper.myweather.data.WeatherContract.LocationEntry;
import com.android.tamzeveloper.myweather.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://com.android.tamzeveloper.weathertabs.app/weather/
        String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.android.tamzeveloper.weathertabs.app/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
                WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.android.tamzeveloper.weathertabs.app/weather/94074
   ...
   assertEquals("Error: the WeatherEntry CONTENT_URI with location should return WeatherEntry.CONTENT_TYPE",
        ...
        // content://com.android.tamzeveloper.weathertabs.app/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.android.tamzeveloper.weathertabs.app/weather/1419120000
       assertEquals("Error: the WeatherEntry CONTENT_URI with location and date should return WeatherEntry.CONTENT_ITEM_TYPE",
               WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.android.tamzeveloper.weathertabs.app/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.android.tamzeveloper.weathertabs.app/location
    ...
    public void testInsertReadProvider() {
        ...
        // Did our content observer get called?   If this fails,then insert location
        // isn't calling getContext().getContentResolver().notifyChange(uri, null);
        tco.waitForNotificationOrFail();
